      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{
          ...
          <div style={{ gridColumn: 'span 1' }}>
            <Image src="/brand/logo.png" alt="The Axiom Collective" width={180} height={60} style={{ objectFit: 'contain', objectPosition: 'left', marginBottom: '1.5rem', display: 'block' }} />
          ...
          <div>
            ...
            {['Home', 'About', 'Services', 'Method', 'Contact'].map(item => (
